  ...
  return (
    <div className="title-wrapper">
      <div className="title-container">
        ...
        <div className="py-3">
          <span className="bg-indigo-100 text-indigo-800 text-xs font-medium mr-2 px-2.5 py-1 rounded-full dark:bg-indigo-900 dark:text-indigo-300">
          ...
          <div className="md:flex justify-between block">
            <div className="left">
              <div className="flex items-center mb-3 mt-3">
                ...
                <span className="icon-text">{venue}</span>
              </div>
              <div className="flex items-center mb-3">
                <span className="icon">
                  <FaCalendar />
          ...
          <div className="flex items-center justify-start flex-wrap">
            {sponsors.map((item, ind) => (
              <SponsorItem key={`sponsor_${ind}`} {...item} />
            ))}
          </div>
        </div>
      </div>
...
const EventDetails = ({ children, ...props }) => {
  return <div className="event-body-wrapper">{children}</div>;
};
